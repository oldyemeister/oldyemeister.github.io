...
hero_image: "/assets/images/LTspice_Schematic_Mixer.png"
hero_alt: "LTspice schematic of the Gilbert-cell mixer and low-pass filter"
hero_caption: "LTspice model used to evaluate the Gilbert-cell mixer, differential output, low-pass filter, and output stage."
...
*Measured receiver output near 100 kHz during prototype validation.*
{: .image-caption}
